...
<script type="text/javascript" src="<?php print_unescaped(OC_Helper::linkTo('atasks/js', 'categories.php')) ?>"></script>
<script type="text/javascript" src="<?php print_unescaped(OC_Helper::linkTo('atasks/js', 'calendars.php')) ?>"></script>
